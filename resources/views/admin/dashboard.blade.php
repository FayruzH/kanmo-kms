...
<div class="container-fluid px-0">
    <section class="kms-hero mb-4">
        ...
        <form method="GET" action="{{ route('admin.overview') }}" class="kms-searchbox">
    ...
    <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center mb-3">
        <form method="GET" action="{{ route('admin.overview') }}" class="row g-2 flex-grow-1">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('admin.sop.create') }}" class="btn btn-primary w-100">Create SOP</a>
            </div>
        </form>
