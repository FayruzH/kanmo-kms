...
<div class="container-fluid px-0">
    <div class="kms-ai-center">
        ...
        <form method="POST" action="{{ route('admin.ai.ask') }}" class="w-100" style="max-width: 780px;">
            @csrf
        ...
        <div class="kms-table-wrap p-4 mt-3">
            ...
            <ul class="mb-0">
                @foreach($items as $item)
                    <li class="mb-2">
                        <a href="{{ route('admin.sop.edit', $item) }}" class="fw-semibold text-decoration-none">{{ $item->title }}</a>
